  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-slate-600 mt-2">Análisis recientes de detección de contenido IA</p>
      </div>
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-slate-900 mb-2">No hay análisis aún</h3>
          <p className="text-slate-600">Realiza tu primer análisis en las secciones de arriba</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((it) => (
            <div key={it.id} className="border rounded-lg bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
