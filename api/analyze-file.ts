  ...
  "recommendations": "Recomendaciones para verificación adicional si es necesario"
      ...
      if (geminiText) {
        try {
          ...
          geminiData = {
            ...
            methodology:
              "Análisis de documento básico por limitaciones técnicas",
            interpretation:
              "No se pudo realizar análisis de documento completo",
            analysis_factors: [],
            key_indicators: ["Análisis limitado"],
            strengths: [],
            weaknesses: ["Respuesta de IA no estructurada"],
            recommendations:
              "Intente con un documento de mayor longitud o diferente formato",
          };
        }
      }
    } catch (geminiError) {
    ...
    const result = {
      ...
      methodology:
        ...
        "Análisis combinado con modelos especializados en detección de documentos",
      interpretation:
      ...
      weaknesses: geminiData?.weaknesses || [
        "Limitaciones en el análisis debido a la longitud del documento",
      ],
      recommendations:
        geminiData?.recommendations ||
        "Para mayor precisión, analice documentos más extensos y detallados",
      technicalDetails: {
        ...
        methodology:
          "60% Hugging Face + 40% Gemini para análisis de documentos",
      },
    };
